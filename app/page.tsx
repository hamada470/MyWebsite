...
export default function Home() {
  const articles = [
    ...
    { 
      ...
      description: 'نوفر أحدث تقنيات تركيب أرضيات رخام طبيعي وصناعي بالرياض مع مراعاة دقة المنسوب والميول وتطبيق نظام القص والتطبيق بالماكينات الحديثة لضمان أفضل مظهر هندسي متناسق وجذاب.' 
    }
  ];
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800 dir-rtl">
      ...
      {/* Articles / Services Section - بخطوط وأوصاف كبيرة */}
      ...
      {/* Gallery Section - 4 صور مضمونة الظهور */}
