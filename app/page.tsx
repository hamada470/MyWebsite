  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800 dir-rtl">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-slate-900/95 backdrop-blur-sm border-b border-slate-800 py-3 px-4 shadow-md flex justify-between items-center">
        <span className="text-white font-bold text-sm md:text-base">ورشة تفصيل رخام الرياض</span>
        <a
          href="tel:0569962482"
          className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm py-2 px-5 rounded-full shadow transition-all flex items-center gap-2"
        >
          <span>📞</span>
          <span>اتصل الآن</span>
        </a>
      ...
      {/* زر الواتساب المهتز المتحرك على شكل أيقونة التطبيق */}
      <a
