...
export default function Home() {
  ...
  return (
    <main style={{ minHeight: '100vh', backgroundColor: '#f9fafb', direction: 'rtl', paddingBottom: '90px', fontFamily: 'sans-serif' }}>
      ...
      {/* الشريط العلوي */}
      <header style={{ position: 'sticky', top: 0, zIndex: 100, padding: '15px 20px', backgroundColor: '#0f172a', color: '#fff', display: 'flex', justifyContent: 'space-between', alignItems: 'center', boxShadow: '0 2px 5px rgba(0,0,0,0.2)' }}>
      ...
      <section style={{ padding: '0 20px', maxWidth: '800px', margin: '0 auto', display: 'grid', gap: '20px' }}>
        ...
        <article style={{ backgroundColor: '#fff', padding: '25px', borderRadius: '15px', boxShadow: '0 4px 6px rgba(0,0,0,0.05)', border: '1px solid #e5e7eb' }}>
